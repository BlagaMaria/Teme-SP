...
title('semnal sinusoidal redresat mono alternanta cu rezolutie temporara de 2 ms')
...
xlabel('t[s]')
ylabel('A[V]')
title('semnal sinusoidal redresat mono alternanta cu rezolutie temporara de 20 ms')
grid;
...
xlabel('t[s]')
ylabel('A[V]')
title('semnal sinusoidal redresat mono alternanta cu rezolutie temporara de 200 ms')
grid;
